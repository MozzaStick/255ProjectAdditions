...
public class crackerClicker extends javax.swing.JFrame implements Money {
    ...
    private static void fillShop() {
        //add crackers
        shop.addCracker("Graham Cracker", 10, 2);
        shop.addCracker("Saltine", 500, 5);
        shop.addCracker("Wheat Thin", 25000, 10);
        shop.addCracker("Ritz Cracker", 125000, 20);
        shop.addCracker("Cheez-It", 1000000, 40);

        //add tools
        shop.addTool("Tastier Crackers", 200, 2);
        shop.addTool("Fancy Packaging", 1000, 5);
        shop.addTool("Advertising", 50000, 10);
        shop.addTool("Celebrity Endorsement", 250000, 20);
        shop.addTool("Cracker Duplicator", 2000000, 40);

        //add clickUpgrades
        shop.addClickUpgrade("Plastic Mouse", 2, 2);
        shop.addClickUpgrade("Iron Mouse", 5, 3);
        shop.addClickUpgrade("Titanium Mouse", 10, 5);
        shop.addClickUpgrade("Adamtanium Mouse", 15, 8);
        shop.addClickUpgrade("Unobtainium Mouse", 20, 15);
        shop.addClickUpgrade("Eldium Mouse", 25, 25);

        //add AutoClikcerUpgrades
        shop.addAutoClickerUpgrade("Auto-Clicker", 5, 1);
        shop.addAutoClickerUpgrade("Better Auto-Clicker", 10, 3);
        shop.addAutoClickerUpgrade("Large Auto-Clicker", 15, 6);
        shop.addAutoClickerUpgrade("Efficient Auto-Clicker", 20, 10);
        shop.addAutoClickerUpgrade("Super Auto-Clicker", 25, 15);
    }
