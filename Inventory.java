...
public class Inventory {
    ...
    private void setAchievements() {
        ...
        Achievement achievementFive = new Achievement("Level 5", 2000, 30);
        achievements.add(achievementFive);
        
        Achievement achievementSix = new Achievement("Level 6", 5000, 40);
        achievements.add(achievementSix);
        
        Achievement achievementSeven = new Achievement("Level 7", 10000, 50);
